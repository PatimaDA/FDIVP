...
original = im2double((imread('W06Q06IMG00.jpg')));
[H, W] = size(original);
...
% the result is different between matlab and octave
original_freq = fft2(original, 1024, 1024);

blurred_freq = original_freq .* motion_freq;  % spectrum of blurred image

% matlab returns real matrix but octave returns complex matrix, wtf?
